...
local gncmr = game:GetService("InsertService"):LoadLocalAsset("rbxassetid://18365805340")
gncmr.Name = "getnamecallmodule"
gncmr.Parent = workspace
getnamecallmethod = require(gncmr)
wait()
